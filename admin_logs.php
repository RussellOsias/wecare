...
<body>
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <div class="container">
                <h2 style="color: #1a73e8;">Admin Logs</h2>
    ...
    <script>
        ...
        document.getElementById('search').addEventListener('input', function() {
            ...
            rows.forEach(row => {
                ...
                const loginTime = row.cells[1].textContent.toLowerCase();
                const logoutTime = row.cells[2].textContent.toLowerCase();
                
                if (email.includes(searchTerm) || loginTime.includes(searchTerm) || logoutTime.includes(searchTerm)) {
                    row.style.display = '';
                } else {
        ...
        document.getElementById('timeFilter').addEventListener('change', function() {
            ...
            rows.forEach(row => {
                const timestamp = parseInt(row.cells[1].getAttribute('data-timestamp')) * 1000;
                const now = Date.now();
        ...
        document.querySelectorAll('#dateRange input').forEach(input => {
            input.addEventListener('change', function() {
                ...
                rows.forEach(row => {
                    const timestamp = new Date(row.cells[1].getAttribute('data-timestamp') * 1000);
